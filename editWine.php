...
$description= filter_input(INPUT_POST, 'description', FILTER_SANITIZE_STRING);//Makes sure that users are unable to hack your code. 
...
$gateway->updateWine($id, $name, $yearMade, $type, $tempurature, $description);
